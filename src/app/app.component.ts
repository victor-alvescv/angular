...
import { MyFirstCompComponent } from "./my-first-comp/my-first-comp.component"; // Is used in the template(html) to render routed components.
...
@Component({
  ...
  imports: [RouterOutlet, MyFirstCompComponent], // Specifies the dependencies (imports) required by this standalone component. Here, RouterOutlet is used for routing purposes;
